...
class Block(pg.sprite.Sprite):
    ...
    def rotate(self, pivot_pos):
        translated = self.pos - pivot_pos  # A' = A - P
        rotated =  translated.rotate(90)   # A" = rotate A'
        return rotated + pivot_pos         # A" + P 
...
class Tetromino:
    ...
    def move(self,direction):
        ...
        if not is_collide: # 모든 블록의 새위치에서 블록 충돌이 아니면 새위치 할당
